...
namespace ADV_Task_06
{
    internal class Program
    {
        ...
        private static void SelectAction(int input, ref string[] masWorkers, ref string[] masPosts)
        {
            ...
            {
                case 1:
                    AddDossierAndPost(ref masWorkers, ref masPosts);
                    break;
                case 2:
                    ShowDossiers(masWorkers, masPosts);
                    break;
                case 3:
                    DeleteDossierAndPost(ref masWorkers, ref masPosts);
                    break;
                case 4:
                    FindBySurname(masWorkers, masPosts);
                    break;
                case 5:
                    Environment.Exit(1);
                    break;
